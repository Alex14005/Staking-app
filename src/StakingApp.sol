...
// Staking fixed amount. E.k: 10.0 tokens
// Stakin reward period
...
contract StakingApp is Ownable {
    ...
    // 2. Withdraw
    function whitdrawTokens() external {
    ...
    function changeStakingPeriod(uint newStakingPeriod_) external onlyOwner {
